...
const PlatformPreviewSection = () => {
    ...
    switch (activeTab) {
      case 'dashboard':
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-primary text-primary-foreground p-6">
                <CardContent className="space-y-2 p-0">
                  <div className="text-3xl font-bold">R$ 2.760</div>
            ...
            <img 
              src={platformMockup} 
              alt="Dashboard da plataforma Clave" 
      ...
      case 'students':
        return (
          <div className="space-y-4">
            {[
              { name: 'Ana Silva', instrument: 'Piano', progress: 85, status: 'Ativa' },
              { name: 'Carlos Lima', instrument: 'Violão', progress: 72, status: 'Ativa' },
              { name: 'Maria Santos', instrument: 'Piano', progress: 93, status: 'Ativa' },
            ].map((student, index) => (
      ...
      case 'schedule':
        return (
          <div className="space-y-4">
            {[
              { time: '09:00', student: 'Ana Silva', instrument: 'Piano', status: 'confirmada' },
              { time: '14:30', student: 'Carlos Lima', instrument: 'Violão', status: 'confirmada' },
              { time: '16:00', student: 'Maria Santos', instrument: 'Piano', status: 'pendente' },
              { time: '19:30', student: 'João Pedro', instrument: 'Piano', status: 'confirmada' },
            ].map((classItem, index) => (
              <Card key={index} className="p-4">
                <CardContent className="flex items-center justify-between p-0">
                  <div className="flex items-center gap-4">
        ...
        return (
          <div className="text-center space-y-8">
            <div className="space-y-4">
              <img 
                src={teacherBadge} 
                alt="Badge de reconhecimento Clave" 
  ...
  return (
    <section className="py-24 bg-tab-cream-bg">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Tab navigation */}
          <div className="flex flex-wrap justify-center gap-2 mb-12 slide-up" style={{ animationDelay: '0.2s' }}>
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <Button
          ...
          {/* Tab content */}
          <Card className="p-8 bg-background border-0 shadow-elegant slide-up" style={{ animationDelay: '0.4s' }}>
