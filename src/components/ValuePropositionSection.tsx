...
const ValuePropositionSection = () => {
  ...
  const benefits = [{
    icon: Target,
    text: "Alunos qualificados e comprometidos"
  }, {
    icon: Clock,
    text: "Flexibilidade total de horários"
  }, {
    icon: Star,
    text: "Sistema de avaliação justo"
  }, {
    icon: Shield,
    text: "Pagamentos garantidos e pontuais"
  }];
  return <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
      {/* Musical decoration */}
      <div className="absolute top-10 left-10 text-8xl opacity-20 note-float">♪</div>
      <div className="absolute bottom-20 right-20 text-6xl opacity-20 note-float" style={{
      animationDelay: '1s'
    }}>♫</div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            ...
            return <Card key={index} className={`${value.color} ${value.textColor} border-0 p-8 text-center slide-up card-musical`} style={{
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-8 mb-16 slide-up">
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                return <div key={index} className="flex items-center gap-4 slide-in-left" style={{
